...
public class Sala implements Serializable {
    ...
    public Sala(int numeroSala, int quantidadeFileiras, int assentosPorFileira) {
        ...
        this.totalAssentos = quantidadeFileiras * assentosPorFileira;
    }
    ...
    public void setQuantidadeFileiras(int quantidadeFileiras) {
        this.quantidadeFileiras = quantidadeFileiras;
        this.totalAssentos = this.quantidadeFileiras * this.assentosPorFileira;
    }
    ...
    public String toString() {
        return "Sala: " + numeroSala +
               " | " + quantidadeFileiras + " fileiras" +
               " | " + assentosPorFileira + " assentos/fileira" +
